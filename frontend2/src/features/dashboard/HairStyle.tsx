...
const HairStyle = () => {
	...
	const [createNewHairStyle, status] = useCreateNewHairStyleMutation();
...
buttonEl = <button className="bg-blue-4 text-white-2  flex items-center justify-center p-2 px-4 my-4 cursor-pointer mx-auto">
